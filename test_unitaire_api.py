...
class TestFlaskApp(unittest.TestCase):
    ...
    def test_obtenir_info_mac_dst(self):
        self.print_test_start("test_obtenir_info_mac_dst")
        response = self.app.get('/api/dst_mac/00:11:22:33:44:55')
        self.assertEqual(response.status_code, 200)
        data = json.loads(response.get_data(as_text=True))
        self.assertIsInstance(data, list)
    ...
    def test_obtenir_info_mac_src(self):
        self.print_test_start("test_obtenir_info_mac_src")
        response = self.app.get('/api/src_mac/AA:BB:CC:DD:EE:FF')
        self.assertEqual(response.status_code, 200)
        data = json.loads(response.get_data(as_text=True))
        self.assertIsInstance(data, list)
    ...
    def test_obtenir_src_mac_plus_de_5_requetes_dhcp_discover_dans_10_secondes(self):
        self.print_test_start("test_obtenir_src_mac_plus_de_5_requetes_dhcp_discover_dans_10_secondes")
        response = self.app.get('/api/alerte_discover')
        self.assertEqual(response.status_code, 200)
        data = json.loads(response.get_data(as_text=True))
        self.assertIsInstance(data, list)
